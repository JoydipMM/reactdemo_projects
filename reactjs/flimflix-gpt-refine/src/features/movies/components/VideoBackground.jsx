...
import { updateCurrentBrowseMovieIndex } from '../moviesSlice';
import useGetBrowseTrailers from '../queries/useGetBrowseTrailers';
...
const VideoBackground = ({ movieID, backdrop, poster }) => {
  ...
  const { data: trailers } = useGetBrowseTrailers(movieID);
