...
export default function Landing() {
  ...
  return (
    <>
      <Breadcrumb pagehierarchy={["Fabricator"]} />
      <Signuparea introductionData={introductionData} />
