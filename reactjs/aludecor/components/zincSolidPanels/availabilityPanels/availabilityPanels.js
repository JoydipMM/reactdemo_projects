...
export default function AvailabilityPanels({ availabilityData }) {
  const allAvailabilityData = availabilityData?.data?.content;
  const availableItems = allAvailabilityData?.availability;
  const settings = {
    arrows: true,
    infinite: true,
    speed: 500,
