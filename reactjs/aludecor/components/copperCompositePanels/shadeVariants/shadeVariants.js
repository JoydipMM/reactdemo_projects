...
export default function ShadeVariants({ shadesData }) {
  ...
  return (
    <>
      <section
        className={`${metalPanelsstyles.shade} slidergallery topadding_top`}
      >
        <div className="container">
          <h2 className="titlecenter">
            <AnimatedText text={allAvailabilityData?.heading} />
            <span>{allAvailabilityData?.description}</span>
          </h2>

          <div className="premium_boxwrp">
            <Slider {...shades} className="commonSlider">
              {availableItems &&
                      ...
                      >
                        <div className="animate_frame">
                          <div className={designspacestyles.colorbox_imgcont}>
                            <Image
                              src={availableItem?.thumbnail_url}
