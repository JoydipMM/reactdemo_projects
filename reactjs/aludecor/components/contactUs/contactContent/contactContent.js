...
export default function Contactcontent({ innerData }) {
  const states = [
    "Andhra Pradesh",
    "Arunachal Pradesh",
    "Assam",
  ...
  const allInnerData = innerData.data?.content;
  const innerDataContent = allInnerData?.contact_info;
    ...
    <>
      <section className="container">
        <div className="topadding_bottom">
          <div className={`${contctstyles.contactdetails}`}>
            <div
              className={`${contctstyles.contactlft}`}
              dangerouslySetInnerHTML={{ __html: innerDataContent }}
            ></div>
            <div className={`${contctstyles.contactrgt}`}>
