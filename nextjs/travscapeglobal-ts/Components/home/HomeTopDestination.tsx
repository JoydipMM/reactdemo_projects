...
export default function HomeTopDestination() {
  return (
    ...
    <Link href="#" className="photo_frame_ara">
        <Image src="/images/46-TigerInSunderban.jpg" width={200} height={96} alt="" title=""  />
        <span className="photoFrame_name">sandakphu<small>Highest Point in West Bengal, India.</small></span>
        <div className="upcoming-tag"><Image width={70} height={66} src="/images/upcoming-tag.png" alt=""  /></div>
        <span className="photo_clip"><Image width={100} height={100} src="/images/clip.png" alt="" title=""  /></span>
    </Link>
    <Link href="#" className="photo_frame_ara">
        <Image src="/images/46-TigerInSunderban.jpg" width={200} height={96} alt="" title=""  />
        <span className="photoFrame_name">sandakphu<small>Highest Point in West Bengal, India.</small></span>
