...
const { userRegistrationController, userLoginController, userTokenController } = require('../controllers/user.controller'); // import user registration controller
...
router.post('/token', userTokenController ); // create auth login route and call user login controller
